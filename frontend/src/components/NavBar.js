...
export default function NavBar() {
  ...
  return (
    <nav className="bg-gray-900/50 backdrop-blur-xl border-b border-gray-800 px-6 py-4 sticky top-0 z-50 shadow-lg">
      <div className="max-w-7xl mx-auto flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-10 text-gray-200">
          ...
          <Link className="hover:text-blue-400 transition font-medium" to="/">
            Events
          </Link>

          <Link className="hover:text-blue-400 transition font-medium" to="/calendar">
            Calendar
          </Link>
